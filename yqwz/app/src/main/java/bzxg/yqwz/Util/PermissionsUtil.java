 ...
 * by
 * https://github.com/SamanLan/Peimissions/blob/master/lib_permisshelper/src/main/java/com/samanlan/lib_permisshelper/PermissionsUtil.java
 */
public final class PermissionsUtil {
     ...
     * @return 返回 {@link PermissionsUtil} 自身，进行链式调用
     */
    public PermissionsUtil withActivity(Activity activity) {
     ...
     * @return 返回 {@link PermissionsUtil} 自身，进行链式调用
     */
    public PermissionsUtil getPermissions(Object object,int requestCode, String... permissions) {
     ...
     */
    @TargetApi(23)
    public PermissionsUtil getPermissionsWithTips(Object object,int requestCode, String[] tips, String... permissions) {
        if (mActivity == null) {
...
//                    this.tipList.clear();
     ...
     * @return 返回 {@link PermissionsUtil} 自身，进行链式调用
     */
    public PermissionsUtil dealResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
...
//            }
    ...
    private void showDialog() {
        final MDDialog mdDialog = new MDDialog(mActivity);
        mdDialog.setListener(new MDDialog.MDClickLIstener() {
            @Override
            public void okClick() {
        ...
        if (deniedTipsList != null) {
//            mdDialog.setText(dealString());
...
//            buffer.append(mActivity.getString(R.string.md_dialog_content_head));
     ...
     * @return 返回 {@link PermissionsUtil} 自身，进行链式调用
     */
    public PermissionsUtil setPermissionsListener(PermissionsListener permissionsListener) {
